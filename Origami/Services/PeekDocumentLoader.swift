...
final class PeekDocumentLoader: NSObject, URLSessionDataDelegate, @unchecked Sendable {
    ...
    func urlSession(_ session: URLSession, task: URLSessionTask, willPerformHTTPRedirection response: HTTPURLResponse,
        ...
        guard let url = request.url, ReaderMedia.safeURL(url.absoluteString) != nil else { completionHandler(nil); return }
